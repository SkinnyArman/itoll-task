export const messages = {
  cart: {
    fetchFailure: "Failed to fetch cart items",
    updateFailure: "Failed to update cart item",
    addFailure: "Failed to add cart item",
    deleteFailure: "Failed to delete cart item",
